...
gem "nokogiri", ">= 1.15.6" #used to parse XML by Vertex, and Milliman
...
gem 'rotp', '6.3.0' # OTP gem for two factor auth. handles generating secret key and validating one time code based on key
...
group :development, :test do
  ...
  gem 'meta_request', '>= 0.7.4' # Required in order to use rails panel https://github.com/dejan/rails_panel
