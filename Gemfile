...
gem 'aws-sdk-s3', '~> 1.208', '>= 1.208.0' # AWS S3 module, (aws-sdk v3) - Swapped with aws-sdk, as newest version will pull in ALL modules. If other modules needed, require those separately.
